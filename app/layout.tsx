...
export default function RootLayout({children}:{children:React.ReactNode}) {return <html lang="pt-BR"><body><DataProvider><WorkspaceCompanyProvider><AppProvider>{children}</AppProvider></WorkspaceCompanyProvider></DataProvider></body></html>}
