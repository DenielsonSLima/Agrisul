...
const baseResources: Record<string, readonly string[]> = {
  ...
  billing_material_categories: ['material-categories', 'materials'],
  billing_materials: ['materials', 'quotations'],
  billing_material_variants: ['materials', 'quotations'],
  billing_fleet_vehicles: ['fleet'],
  billing_quotations: ['quotations'],
  billing_quotation_items: ['quotations'],
  billing_quotation_providers: ['quotations'],
  billing_quotation_provider_values: ['quotations'],
  billing_quotation_negotiations: ['quotations'],
  billing_quotation_item_awards: ['quotations'],
  billing_purchase_orders: ['purchase-orders'],
  billing_purchase_order_items: ['purchase-orders'],
  billing_payment_methods: ['payment-methods', 'purchase-orders'],
