...
import {ArrowLeft, ArrowRight, CheckCircle2, ChevronLeft, ChevronRight, CircleDot, ClipboardList, Clock3, FileText, LayoutGrid, List, Paperclip, Plus, ReceiptText, ShieldCheck, Wrench} from 'lucide-react';
