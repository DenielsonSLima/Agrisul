...
const labels: Record<AgendaKind, [string, string]> = {
  ...
  receipt:['recebimento','recebimentos'], advance:['adiantamento','adiantamentos'],
};
export const agendaColors: Record<AgendaKind, string> = {contract:'#5877b7',start:'#9670c5',end:'#dc9656',load:'#299581',receipt:'#78a540',advance:'#b69a33'};
