...
try{
 ...
 const metrics={loadedVolume:'250',averageAtr:'121.5',grossAmount:'150000.75',discountAmount:'2000.25',netAmount:'148000.50',advanceAmount:'25000.15',receiptAmount:'35000.35',receivedAmount:'60000.50',pendingAmount:'88000',creditAmount:'0',billingPending:false};
 const empty={...metrics,loadedVolume:'0',averageAtr:'',grossAmount:'0',discountAmount:'0',netAmount:'0',advanceAmount:'0',receiptAmount:'0',receivedAmount:'0',pendingAmount:'0',creditAmount:'0'};
 ...
 assert.deepEqual(model.financialItems.map(item=>item.key),['gross','discount','net','advance','receipt','received','pending','credit']);
 ...
 console.log('Passed: eight financial indicators, delivery balance, payment-only months, credits, unavailable/pending states, RPC totals, full histories, long notes and PDF footer safety in both orientations.');
